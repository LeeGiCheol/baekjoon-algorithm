...
public class _02_1620 {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Integer> pokemonNumberMap = new HashMap<>();
        Map<Integer, String> pokemonNameMap = new HashMap<>();

        for (int i = 0; i < N; i++) {
            String pokemon = sc.next();
            pokemonNumberMap.put(pokemon, i+1);
            pokemonNameMap.put(i+1, pokemon);
        }

        for (int i = 0; i < M; i++) {
            if (sc.hasNextInt()) {
                System.out.println(pokemonNameMap.get(sc.nextInt()));
            } else {
                System.out.println(pokemonNumberMap.get(sc.next()));
            }
        }
    }
